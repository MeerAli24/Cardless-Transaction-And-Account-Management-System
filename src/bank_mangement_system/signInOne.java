...
public class signInOne extends JFrame implements ActionListener{
    Long random;
    JTextField nameTextField,pinTextField ,fnameTextField,cityTextField,stateTextField,addressTextField,emailTextField;
    JButton next;
    JRadioButton male, fmale, married, unmarried, single;
    ...
    signInOne()
	{
		...
		//  math.abs  is used to  convert the  neggative number into  poositive 
